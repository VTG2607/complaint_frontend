    ...
    useEffect(() => {
        const fetchComplaints = async (categoryId = "") => {
            try {
                ...
                const url = categoryId ? `https://complaint-backend-4863a97516ff.herokuapp.com/api/complaint/category/${categoryId}` : "https://complaint-backend-48f344d05183.herokuapp.com/api/complaint/";
