...
export function Home(){
    return (
        <>
            ...
            <div className="bg-gradient-to-b  w-screen min-h-screen from-blue-200 to-blue-500 flex flex-col justify-center items-center">
                <UserIcon className="text-2xl"/>
                <h1 className="title text-7xl font-bold font-mono">Homepage</h1>
